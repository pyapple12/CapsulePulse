...
- **PL008 布局翻新**（2026-09-12 立项，待开工）→ 附录 PL008
- **PL009 光与生命感**（2026-09-12 立项，待开工）→ 附录 PL009

（PL007–PL009 为 UI 三连迭代：材质 → 布局 → 动效；之后的大件：Phase 6 打包分发 → Phase 7 三端适配，未立项）
...
> 状态：🔨 待开工（2026-09-12 立项；任务清单见 x.progress.md「PL008」）
...
> 状态：🔨 待开工（2026-09-12 立项；任务清单见 x.progress.md「PL009」）
