...
- **PL011 焦点联动材质·平时透明聚焦磨砂**（未开始：平时 alpha 透明常驻 + 聚焦瞬间挂 DWM Acrylic 背板、失焦撤回透明）→ 附录 PL011

（UI 三连与 PL010 材质返工均已收口；PL011 为用户拍板的材质演进路线，承接 PL010.7 实证的"失焦真磨砂无受支持途径"边界；再往后未规划，由用户定）
