...
- **FIX001 第 1 轮审计修复**（2026-09-09 立项，待开工）→ 附录 A001（任务清单见 x.progress.md「FIX001」）
...
2. **configs/ 目录语义**（来源 A001-O5，2026-09-09 定案）：configs/ 留给未来"程序读的固定参数"，用户参数按计划书定案落 `~/.capsule-pulse/`——AGENTS.md:62 的预测性注释不视为文档失实，首个固定参数落地时自然消解。
...
> 状态：📌 待修复（FIX001 任务清单见 x.progress.md）
