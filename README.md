...
[![Version](https://img.shields.io/badge/Version-0.1.0.9-blue.svg)](core/Cargo.toml)
[![Rust](https://img.shields.io/badge/Rust-1.96-orange.svg)](https://www.rust-lang.org)
[![Phase](https://img.shields.io/badge/Phase-PL006_完成-brightgreen.svg)](z.plan.md)
...
| 玻璃 UI  | 苹果 Liquid Glass 理念：单一玻璃配方 + 高光内描边 + 同心圆角，深浅色自适应 |
| 常驻后台 | 托盘常驻、全局快捷键唤起、关闭最小化到托盘                                 |

> 当前状态：**PL001–PL006 已完成**（V0.1.0.9）——玻璃壳计时闭环 + 存储统计 + 提醒设置 + 托盘常驻 + 工作日/打卡模型与统计视图 + 苹果玻璃 UI 重设计（Liquid Glass 令牌化，纯前端）；89 项测试全绿（含 1 项存储探针集成测试）。下一个大件：打包分发，未立项。方案与实测结论见 `z.plan.md` 附录，任务档案见 `x.progress.md`。
